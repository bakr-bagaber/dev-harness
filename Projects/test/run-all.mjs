...
const SUITES = [
  ...
  { file: 'test-t8.mjs',      name: 'T8 Inner Ralph Loop (covered by T10)' },
  ...
  { file: 'test-t19.mjs',     name: 'T19 Hermes Skill Wrapper' },
  { file: 'test-t20.mjs',     name: 'T20 Packaging & Distribution' },
  { file: 'test-t21.mjs',     name: 'T21 Docs Site Scaffolding' },
  { file: 'test-t22.mjs',     name: 'T22 Coverage Gates (covered by T7)' },
  { file: 'test-t23.mjs',     name: 'T23 Cross-Platform' },
...
for (const suite of SUITES) {
  ...
  try {
    ...
    if (QUICK && suite.file.includes('t9')) continue; // skip slow outer loop
