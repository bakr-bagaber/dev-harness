 ...
 *   - AGENTS.md is ~120 lines, TOC-style, progressive disclosure
...
function testAgentsMdContent() {
  ...
  // ~120 lines (well under 120)
  assertP(lines.length < 120, `B.1 AGENTS.md has ${lines.length} lines, expected < 120`);
...
function testInitCommand() {
  ...
  assertP(agentsLines.length < 120, `F.22 init produces AGENTS.md with ${agentsLines.length} lines (< 120)`);
